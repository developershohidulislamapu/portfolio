 ...
 <!--/ Intro Skew Star /-->
 <div id="home" class="intro route bg-image" style="background-image: url({{asset('frontend')}}/img/intro-bg.jpg)">
              ...
              <div class="col-md-6">
                <div class="row">
                  <div class="col-sm-6 col-md-5">
                    <div class="about-img">
                      <img src="{{asset('frontend')}}//img/testimonial-2.jpg" class="img-fluid rounded b-shadow-a" alt="">
                    </div>
                  </div>
